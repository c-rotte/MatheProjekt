...
public class SettingsScene extends Scene{
	...
	public SettingsScene(Game container) {
		...
		checkBoxHolder.addElement(new CheckBox(this, "darkmode", 50, 170, 30, Color.LIGHT_GRAY, Color.DARK_GRAY).addText("Dunkler Modus", Color.WHITE).setClicked(Settings.DARKMODE));
